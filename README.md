...
Move `/CaseStudy/projects` folder to `ValExtractor/Evaluation/projects`.

Move `/Evaluation/projects` folder to `ValExtractor/CaseStudy/projects`.
...
Select directory(path to **Implementation/ValExtractor**) and Click `Finish`
